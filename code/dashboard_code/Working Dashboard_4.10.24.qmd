...
output$map <- renderLeaflet({
  leaflet() |> 
    ...
    addCircleMarkers(data = map_df(), 
                     radius = 0.25, 
                     fillOpacity = 0.75,
                     color = ifelse(map_df()$outcome_recode == "warning", "#f0f921",
                                    ifelse(map_df()$outcome_recode == "citation", "#ed7953",
                                           ifelse(map_df()$outcome_recode == "summons", "#9c179e",
...
output$map_race <- renderLeaflet({
  leaflet() |> 
    ...
    addCircleMarkers(data = map_race(), 
                     radius = 0.25, 
                     fillOpacity = 0.75,
                     color = ifelse(map_race()$subject_race == "white", "#fcfdbf",
                                    ifelse(map_race()$subject_race == "black", "#f1605d",
                                           ifelse(map_race()$subject_race == "hispanic", "#721f81",
                                                  ifelse(map_race()$subject_race == "asian/pacific islander", "#000004", "gray")))))
...
output$map_gender <- renderLeaflet({
  leaflet() |> 
    ...
    addCircleMarkers(data = map_gender(), 
                     radius = 0.25, 
                     fillOpacity = 0.75,
                     color = ifelse(map_gender()$subject_sex == "male", "#fde725",
...
output$map_age <- renderLeaflet({
  leaflet() |> 
    ...
    addCircleMarkers(data = map_age(), 
                     radius = 0.25, 
                     fillOpacity = 0.75,
                      color = ifelse(map_age()$age_group == "18-24", "#fac228",
                                    ifelse(map_age()$age_group == "25-34", "#f57d15",
                                           ifelse(map_age()$age_group == "35-44", "#d44842",
                                                  ifelse(map_age()$age_group == "45-54", "#9f2a63",
                                                  ifelse(map_age()$age_group == "55-64", "#65156e",
                                                 ifelse(map_age()$age_group == "65-74", "#280b53",     
                                                 ifelse(map_age()$age_group == "75 and over", "#000004",  
                                                   ifelse(map_age()$age_group == "Under 18", "#fcffa4",     
                                                         "gray")))))))))
