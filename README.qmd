...
Codebook will generate in a new tab!
...
attr(camden_philly_clean$date, "shortDescription") <- "The date of the stop, in YYYY-MM-DD format."
attr(camden_philly_clean$year, "shortDescription") <- "The year of the stop, in YYYY format."
attr(camden_philly_clean$lat, "shortDescription") <- "The latitude of the stop."
attr(camden_philly_clean$lng, "shortDescription") <- "The longitude of the stop."
attr(camden_philly_clean$location, "shortDescription") <- "City of stop"
attr(camden_philly_clean$subject_age, "shortDescription") <- "The age of the stopped subject. When date of birth is given, we calculate the age based on the stop date."
attr(camden_philly_clean$subject_race, "shortDescription") <- "The race of the stopped subject. Values are standardized to white, black, hispanic, asian/pacific islander, and other/unknown"
attr(camden_philly_clean$subject_sex, "shortDescription") <- "The recorded sex of the stopped subject."
attr(camden_philly_clean$outcome, "shortDescription") <- "The outcome of the stop."
attr(camden_philly_clean$outcome_recode, "shortDescription") <- "The outcome of the stop where N/A entries are recoded as 'No outcome'."

codebook <- makeCodebook(data = camden_philly_clean, replace = TRUE) 
